import { parseEventDate, isCalendarDate } from '../../utils/calendarDate.js';
/**
 * @file 事件详情模态框
 * 显示事件完整信息和状态控制
 */
...
import EventDetailsPanel from '../../components/events/EventDetailsPanel.jsx';
...
function formatDateTime(dateStr) {
  ...
  try {
    ...
    if (isCalendarDate(dateStr)) return date.toLocaleDateString('zh-CN');
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)] space-y-6">
            ...
            {/* 复用当前事件契约的统一详情入口，避免管理员页面维护另一套字段路径。 */}
            <section>
              <h3 className="text-sm font-medium text-gray-400 uppercase tracking-wider mb-3">
                详细信息
              </h3>
              <div data-testid="event-contract-details" className="bg-gray-800 rounded-lg p-4">
                <EventDetailsPanel
                  event={event}
                  showHeader={false}
