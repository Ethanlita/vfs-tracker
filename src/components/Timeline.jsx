    ...
    <div className="dashboard-container relative px-3 sm:px-0">
      ...
      <div className="dashboard-card">
        <div className="dashboard-card-header">
          ...
          <p className="dashboard-card-description">个性化鼓励和建议</p>
        </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div className="flex-1 max-w-2xl">
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-100 rounded-2xl rounded-tl-sm px-6 py-4 shadow-md relative">
              {/* 聊天气泡箭头 */}
              <div className="absolute left-0 top-4 w-0 h-0 border-t-[8px] border-b-[8px] border-r-[12px] border-t-transparent border-b-transparent border-r-purple-100 transform -translate-x-[12px]"></div>
              <div className="absolute left-0 top-4 w-0 h-0 border-t-[8px] border-b-[8px] border-r-[12px] border-t-transparent border-b-transparent border-r-purple-50 transform -translate-x-[11px]"></div>
                ...
                {isLoadingMessage ? (
                  <span className="flex items-center">
                    <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-purple-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                      <path className="opacity-75" fill="currentColor" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"></path>
                    </svg>
                    AI 正在思考...
                  </span>
                ) : (
